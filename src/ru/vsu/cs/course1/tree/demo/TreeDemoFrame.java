...
public class TreeDemoFrame extends JFrame {
    ...
    private JTextField textFieldFindMax;
        ...
        ButtonFindMax.addActionListener(actionEvent -> {
            showSystemOut(() -> {
                ...
                for (Integer i : BinaryTreeAlgorithms.preOrderValues(tree.getRoot())) {
                    if ((i == tree.getRoot().getValue()) && (count == 0)) {
                        count++;
                        continue;
                    }
                    if (i > max) {
                ...
                textFieldFindMax.setText(String.valueOf(max));
            });
        });
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel2.add(ButtonFindMax, new GridConstraints(2, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        textFieldFindMax = new JTextField();
        panel2.add(textFieldFindMax, new GridConstraints(2, 3, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
